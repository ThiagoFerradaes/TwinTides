...
public class ZombieOneOneBetterPunchPrefab : EnemyAttackPrefab {
    ZombieOneOne _info;
    ...
    private void DefinePosition() {
        ...
        if (!_info.BetterPunchSound.IsNull) RuntimeManager.PlayOneShot(_info.BetterPunchSound, transform.position);
    ...
    private void OnTriggerEnter(Collider other) {
        ...
        health.DealDamage(_info.damageOfBetterPunch, true, true);
    }
}
