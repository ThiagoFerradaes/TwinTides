...
public class BlackBeardStraightBullet : BlackBeardAttackPrefab {
    ...
    private void DefinePosition() {
        ...
        if (!_info.ShootStraightSound.IsNull) RuntimeManager.PlayOneShot(_info.ShootStraightSound, transform.position);
